...
const FilterSidebar = props => {
    const { filters, filterCountToOpen, onCallbackCurrentFilterProps } = props;
    ...
    useEffect(() => {
        if (typeof onCallbackCurrentFilterProps === 'function') {
            onCallbackCurrentFilterProps(talonProps);
        }
    }, [filterState]);
    ...
    const isHideCurrentFilter = !!onCallbackCurrentFilterProps;
